...
const express = require('./task1-rest-api/express');

// Create an instance of the Express application
const app = express();

// Import configuration settings
const config = require('./task1-rest-api/config');
...
app.get('/api', (req, res) => {
    ...
    const response = {
        "slack_name": 'Ibukun Alesinloye',  // Replace with the actual slack_name
        "day": currentDay,
        "utc_timestamp": utcTime,
        "track": 'Backend',  // Replace with the actual track
